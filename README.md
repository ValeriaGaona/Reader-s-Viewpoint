...
| ----------------- | -------------------------------- | ---------------------------------------------------------------------------- | ------------------------------------------- |
| **SABER (4 pts)** | Tabla comparativa de plataformas | Comparación Play Store, App Store, App Gallery + referencias                 | [Ver PDF](https://github.com/ValeriaGaona/Reader-s-Viewpoint/blob/main/GarciaGaonaValeriaGTID141-LaraCarrilloSusanaDafneGTID143-Saber-U4.pdf)            |
...
|                   | Screenshots             | Capturas de pantalla del funcionamiento de la aplicación                          | [Ver PDF](https://github.com/ValeriaGaona/Reader-s-Viewpoint/blob/main/Screenshots.pdf) |
